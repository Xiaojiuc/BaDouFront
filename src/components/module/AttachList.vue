            ...
            <card>
                ...
                <div class="table-responsive">
                    ...
                    >
                        ...
                        <el-table-column label="附件名称" property="attachName">
                            <template slot-scope="scope">
                                <span class="download-btn" @click="downloadAttach(scope.row.attachId)">{{scope.row.attachName}}</span>
                            </template>
                        </el-table-column>
                        <el-table-column label="上传时间" property="createTimeDesc"></el-table-column>
                        <el-table-column label="大小" property="attachSize" :formatter="sizeFormatter"></el-table-column>
                    </el-table>
                </div>
            </card>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            downloadAttach(attachId) {
                let url = `${this.INTERFACE.downloadAttach}?attachId=${attachId}`
                window.open(url)
            }
        },
        watch: {
            resourceId: {
                ...
                handler: function () {
                    ...
                    this.get(url, {resourceId: this.resourceId}, (isSuccess, data) => {
