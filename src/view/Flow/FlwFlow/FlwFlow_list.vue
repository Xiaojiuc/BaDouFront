    ...
    let default_btn = [
        {
            ...
            click: function () {
                ...
                let listPath = this.$parent.$route.path
                this.$router.push({
                    path: `/Flow/FlwFlow/FlwFlow_edit/${this.module.code}/${selection[selection.length - 1].id}`,
                    query: {
                        data: {
                            returnPath: listPath
                        }
    ...
    export default {
        ...
        created() {
            this.$nextTick(() => {
                ...
                this.newModuleInfo(this.$route.params.mdCode, this.$route.params.symbol)
            })
            PermissionUtils.addRouter({
                component: 'Flow/FlwFlow/FlwFlow_edit',
                path: 'Flow/FlwFlow/FlwFlow_edit/:mdCode/:id',
        ...
        beforeRouteUpdate(to, from, next) {
            ...
            this.newModuleInfo(mdCode, to.params.symbol)
            next()
        }
    }
</script>
