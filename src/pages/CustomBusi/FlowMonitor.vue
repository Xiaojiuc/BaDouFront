    ...
    <div class="address-book-dialog">
        ...
        <div style="margin-left: 25px;">
            ...
            <div style="background-color: #f9f4f4">
                ...
                <p>
                    状态：<span style="color: green;">{{config.flow.statusDesc}}</span>
                    &nbsp;&nbsp;&nbsp;
                    创建时间：<span>{{config.flow.createDate}}</span>
                    &nbsp;&nbsp;&nbsp;
                    归档时间：<span>{{config.flow.archiveDate}}</span>
                </p>
            </div>
            <!-- 处理人颜色块说明 -->
            <div>
            ...
            <!-- 操作按钮 -->
            <div style="margin-bottom: 20px;  border-bottom: 1px solid; border-bottom-color: #ccc;">
                  ...
                  label="处理人">
                    <template slot-scope="scope">
                        <span v-for="h,index in scope.row.actualHandler" :key="h.wid">
                            <el-checkbox v-if="h.status === 1 || h.status === 3" :true-label="h.wid" @change="setChooseWids($event, scope.row.id, index)">
...
<script>
    import LPagination from 'src/components/Pagination'
    ...
    export default {
        ...
        methods: {
            ...
            loadNodeListJSON() {
                ...
                this.post(this.nodeListURL, params, (isSuccess, res) => {
            ...
            transfer() {
                ...
                this.addressBook({
                    ...
                    _this.$confirm('您确定要将选定的处理人转办至【' + data.map(d => d.name).join(',') + '】吗？' , '转办', {
                        ...
                        _this.$prompt('', '转办意见填写', {
                            ...
                            _this.post(`${_this.BASEURL}/instance/flow/flowinstancemonitor/transfer.do`, params, (isSuccess, res) => {
                                if (res.hasOk) {
                                    console.info(_this)
                                    _this.loadNodeListJSON()
                                    _this.chooseWids = Object.assign({}, {length: 0})
            ...
            jump() {
                ...
                this.post(`${this.BASEURL}/instance/node/nodeinstanceselectlist/listJSON.do`, params, (isSuccess, res) => {
            ...
            nodeSubmitClick() {
                ...
                this.post(`${this.BASEURL}/instance/flow/flowinstancemonitor/jump.do`, params, (isSuccess, res) => {
                    if (res.hasOk) {
                        this.loadNodeListJSON()
            ...
            rehandle() {
                this.$confirm('您确定要将当前流程文档实例重处理吗?' , '重处理', {
                    ...
                    this.$prompt('', '重处理意见填写', {
                        ...
                        this.post(`${this.BASEURL}/instance/flow/flowinstancemonitor/rehandle.do`, params, (isSuccess, res) => {
                            if (res.hasOk) {
                                this.loadNodeListJSON()
                                this.alert('操作成功', 'success')
                            } else {
